      ...
      <div className="flex gap-4 p-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-[13px] text-gray-600 mb-1.5 flex items-center">
            <svg className="w-4 h-4 mr-1.5 text-red-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="text-[13px] text-gray-600 mb-3 flex items-center">
            <svg className="w-4 h-4 mr-1.5 text-orange-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
